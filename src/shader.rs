...
pub fn load_shader_program() -> Result<u32> {
...
pub fn create_shader_program(vertex_src: &str, fragment_src: &str) -> Result<u32> {
    ...
    let vert_shader_source =
        CString::new(vertex_src).context("Failed to create CString for vertex shader")?;
    ...
    let frag_shader_source =
        CString::new(fragment_src).context("Failed to create CString for fragment shader")?;
